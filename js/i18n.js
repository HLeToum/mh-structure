...
(function () {
  ...
  const dict = {
    fr: {
      ...
      'about.h2':           'Un bureau d\'études structure à votre service',
      'about.p1':           'MH-Structure est un bureau d\'études structure qui accompagne maîtres d\'ouvrage, architectes et particuliers dans leurs projets de construction neuve et de réhabilitation. Nous intervenons à chaque étape d\'un ouvrage, du dimensionnement initial au diagnostic des désordres, avec rigueur et méthode.',
      'about.p2':           'Nos compétences couvrent le calcul de structures, le diagnostic technique et le contrôle réglementaire, notamment sur les aspects liés à la sismicité pour les bâtiments soumis à ces exigences.',
    ...
    en: {
      ...
      'about.h2':           'A structural engineering firm at your service',
      'about.p1':           'MH-Structure is a structural engineering consultancy that supports project owners, architects and private clients in their new construction and renovation projects. We intervene at every stage of a structure, from initial sizing to defect diagnosis, with rigour and methodology.',
      'about.p2':           'Our expertise covers structural calculations, technical diagnostics and regulatory compliance, particularly regarding seismic requirements for buildings subject to these constraints.',
